...
async def analyze_interests(request: InterestAnalyzeRequest, _: None = Depends(limit_interest_analysis), service: AIService = Depends(get_ai_service)) -> ApiResponse[InterestAnalysis]:
    try:
